<template>
    <div v-if="dataReady" class="print-block">
        ...
        <div style="font-size:9pt; margin-bottom: 0.5rem;">
            <b>Total Number of 'Certificate of Service' Applications:</b> <span style="font-size:11pt;" class="text-primary">{{csvInfo[0].total}} </span>
        </div>
...
export default class CsvTable extends Vue {
    ...
    public extractInfo(){
       this.csvInfo = [this.results.application_details.CSV];
    }
