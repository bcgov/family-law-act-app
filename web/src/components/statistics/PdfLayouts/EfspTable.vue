<template>
    <div v-if="dataReady" class="print-block">
        ...
        <div style="font-size:9pt; margin-bottom: 0.5rem;">
            <b>Total Number of 'Electronic Filing Statement' Applications:</b> <span style="font-size:11pt;" class="text-primary">{{efspInfo[0].total}} </span>
        </div>
...
@Component
export default class EfspTable extends Vue {

    @Prop({required:true})
    results!: reportInfoType;
       
    dataReady = false; 
    efspInfo: formReportInfoType[] = [];
    ...
    public extractInfo(){
       this.efspInfo = [this.results.application_details.EFSP];
    }
