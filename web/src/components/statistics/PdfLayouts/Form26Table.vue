<template>
    <div v-if="dataReady">
        <div style="font-size:12pt; font-weight:600; margin-bottom: 0.5rem;" >Form 26: </div>
        <b-table            
            :items="form26_info"
            :fields="fields"
            bordered            
        ...
        <div 
            ...
            <b>Total Number of Form 26 Applications:</b> {{results.form26.total}} 
        </div>
        <div 
            v-if="displayTopUser" 
...
@Component
export default class Form26Table extends Vue {
    ...
    public extractInfo(){
       this.form26_info = [this.results.form26];
       this.topUser_info = [this.results.form26.top_user];
    }   
