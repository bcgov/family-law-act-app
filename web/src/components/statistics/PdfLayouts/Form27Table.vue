<template>
    <div v-if="dataReady">
        <div style="font-size:12pt; font-weight:600; margin-bottom: 0.5rem;" >Form 27: </div>
        <b-table            
            :items="form27_info"
            :fields="fields"
            bordered            
        ...
        <div 
            ...
            <b>Total Number of Form 27 Applications:</b> {{results.form27.total}} 
        </div>
        <div 
            v-if="displayTopUser" 
...
@Component
export default class Form27Table extends Vue {
    ...
    topUserFields = [
        ...
        {key:"drafted",      label:"Drafted",                thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"unsuccessful", label:"Unsuccessful eFiling",   thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'},
        {key:"total",        label:"Total Form 27 Applications", thClass: 'border-bottom align-middle text-center', tdClass:'align-middle text-center'}
    ]; 
    ...
    public extractInfo(){
       this.form27_info = [this.results.form27];
       this.topUser_info = [this.results.form27.top_user];
    }  
