<template>
    <div v-if="dataReady" class="print-block">
        ...
        <div style="font-size:9pt; margin-bottom: 0.5rem;">
            <b>Total Number of 'Request for Service of Documents' Applications:</b> <span style="font-size:11pt;" class="text-primary">{{rfsInfo[0].total}} </span>
        </div>
...
@Component
export default class RfsTable extends Vue {

    @Prop({required:true})
    results!: reportInfoType;
       
    dataReady = false; 
    rfsInfo: formReportInfoType[] = [];
    ...
    public extractInfo(){
       this.rfsInfo = [this.results.application_details.RFS];
    }
