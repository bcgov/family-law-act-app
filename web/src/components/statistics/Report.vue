<template>
    <div class="report">
        ...
        <flm-table class="mt-5" :results="results"/>
        <po-table class="mt-5" :results="results"/>
        <ppm-table class="mt-5" :results="results"/>
...
import NlpTable from './PdfLayouts/NlpTable.vue';
import NprTable from './PdfLayouts/NprTable.vue';
