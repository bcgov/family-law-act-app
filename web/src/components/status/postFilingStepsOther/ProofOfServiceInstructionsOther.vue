<template>
    <b-card no-body bg-variant="white" border-variant="white">                           
        ...
        <p>
            The court {{mustProvide? 'will' : 'may'}} need proof you had the documents personally served.
            ...
            so that you can prove {{mustProvide?
            'service of the documents. You must attach a copy of the documents to the Certificate of Service.':
            'personal service of the documents to the Certificate of Service.' 
            }}
...
export default class ProofOfServiceInstructionsOther extends Vue {
