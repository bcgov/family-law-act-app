...
import Form46Layout from "./Form46Layout.vue"
...
export default class Form46 extends Vue {
    ...
    public onPrint() { 
        ...
        const bottomLeftText = `"PFA 763    `+moment().format("MM/YYYY")+` \\a           Form 46";`;
        const bottomRightText = `" Notice of Address Change | "`
