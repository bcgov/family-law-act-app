...
import surveyJson from "./forms/electronic-filing-statement-aps.json";
...
export default class ElectronicFilingStatementAps extends Vue {
    ...
    public reloadPageInformation() {
        ...
        if (this.step.result?.electronicFilingStatementApsSurvey) {            
            this.survey.data = this.step.result.electronicFilingStatementApsSurvey.data;   
    ...
    beforeDestroy() {
        ...
        this.UpdateStepResultData({step:this.step, data: {electronicFilingStatementApsSurvey: Vue.filter('getSurveyResults')(this.survey, this.currentStep, this.currentPage)}})
    }
}
</script>
