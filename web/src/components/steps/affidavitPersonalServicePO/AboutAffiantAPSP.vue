...
export default class AboutAffiantApsp extends Vue {
    ...
    public reloadPageInformation() {
        ...
        if (this.step.result?.aboutAffiantApspSurvey){
            this.survey.data = this.step.result.aboutAffiantApspSurvey.data; 
