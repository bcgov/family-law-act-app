...
export default class ElectronicFilingStatementApsp extends Vue {
    ...
    public reloadPageInformation() {
        ...
        if (this.step.result?.electronicFilingStatementApspSurvey) {            
            this.survey.data = this.step.result.electronicFilingStatementApspSurvey.data;   
    ...
    beforeDestroy() {
        ...
        this.UpdateStepResultData({step:this.step, data: {electronicFilingStatementApspSurvey: Vue.filter('getSurveyResults')(this.survey, this.currentStep, this.currentPage)}})
    }
}
</script>
