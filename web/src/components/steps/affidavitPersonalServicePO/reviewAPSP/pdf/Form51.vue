...
export default class Form51 extends Vue {
    ...
    public onPrint() { 
        ...
        const pdf_type = Vue.filter('getPathwayPdfType')("electronicFilingStatementApsp");
        const pdf_name = "electronic-filing-statement-apsp";       
        const el = document.getElementById("print");

        const applicationId = this.$store.state.Application.id;
        const bottomLeftText = `"PFA768    `+moment().format("MM/YYYY")+` \\a           Form 51";`;
        ...
        .then(res => {
            ...
            this.UpdatePathwayCompleted({pathway:"electronicFilingStatementApsp", isCompleted:true});
