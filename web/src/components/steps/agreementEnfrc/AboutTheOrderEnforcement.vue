...
import surveyJson from "./forms/about-the-order-enforcement.json";
...
export default class AboutTheOrderEnforcement extends Vue {
    ...
    beforeDestroy() {
        ...
        this.UpdateStepResultData({step:this.step, data: {aboutTheOrderEnforcementSurvey: Vue.filter('getSurveyResults')(this.survey, this.currentStep, this.currentPage)}})
    }
}
</script>
