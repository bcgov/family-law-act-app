...
import surveyJson from "./forms/attendance-using-electronic-communication.json";
...
export default class AttendanceUsingElectronicCommunication extends Vue {
    ...
    public reloadPageInformation() { 
        ...
        if (this.step.result?.attendanceUsingElectronicCommunicationSurvey) {
            this.survey.data = this.step.result.attendanceUsingElectronicCommunicationSurvey.data; 
