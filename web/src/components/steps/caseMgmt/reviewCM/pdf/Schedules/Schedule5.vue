<template>
    ...
    <div class="new-page"></div>
        ...
        <div style="width: 80%; float: left; margin-right: 10px;">
            ...
            <div style="text-indent: -0px;text-align: justify;text-justify: inter-word;">
                <table style="margin-left:30px;">
                            <tr>
                            <td><div style="text-align:center;width:120px;background-color: #dedede;padding:2px;font-size: 11pt;min-height:25px;margin-bottom:10px;">{{ outsideBCinfo.orderDate | beautify-date-full}}</div> <div><div style="margin-left:0px;text-align: center;font-size:7pt;margin-top:-12px;">Date (dd/mmm/yyyy)</div></div></td>
        ...
        <div style="width: 80%; float: left; margin-right: 10px;margin-top:15px;">
            <div style="background: #626262; color: white; font-size: 10.5pt;padding:2px;">
                <b>Part 2 | Other party’s contact information</b>
            </div>
            <div style=" display:inline;margin-left:15px;">
        ...
        <!-- <div>
                ...
                <div style="flex:1;  margin-right: 10px;width:80%">
                    ...
                    <div>
                        ...
                        <div style="margin: 0.5rem 0.5rem 0.5rem 1rem;">
