...
export default class ElectronicFilingStatementCsv extends Vue {
    ...
    public reloadPageInformation() {
        ...
        if (this.step.result?.electronicFilingStatementCsvSurvey) {            
            this.survey.data = this.step.result.electronicFilingStatementCsvSurvey.data;   
    ...
    beforeDestroy() {
        ...
        this.UpdateStepResultData({step:this.step, data: {electronicFilingStatementCsvSurvey: Vue.filter('getSurveyResults')(this.survey, this.currentStep, this.currentPage)}})
    }
}
</script>
