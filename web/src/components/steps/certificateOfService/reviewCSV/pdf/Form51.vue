...
export default class Form51 extends Vue {
    ...
    public onPrint() { 
        ...
        .then(res => {
            ...
            this.UpdatePathwayCompleted({pathway:"electronicFilingStatementCsv", isCompleted:true});
    ...
    public getEFSPResultData() {         
        ...
        for(const stepIndex of [this.stPgNo.OTHER._StepNo, this.stPgNo.CSV._StepNo]){
