<template>
    <page-base v-bind:hideNavButtons="!showTable" v-bind:disableNext="isDisableNext()" v-bind:disableNextText="getDisableNextText()" v-on:onPrev="onPrev()" v-on:onNext="onNext()">
        ...
        <b-modal size="xl" v-model="popInfo" header-class="bg-white" no-close-on-backdrop hide-header>
            ...
            <div 
                class="m-3" 
                v-if="flmInfo || flmCaseMngmntInfo || flmPpmInfo || relocFlmInfo || flmEnfrcInfo || relocFlmPpmInfo || ppmFlmEnfrcInfo || relocFlmEnfrcInfo">
                ...
                <p>
                    ...
                    <span v-if="flmPpmInfo || relocFlmInfo || flmEnfrcInfo || relocFlmPpmInfo || ppmFlmEnfrcInfo || relocFlmEnfrcInfo">
                ...
                <p v-if="flmEnfrcInfo || ppmFlmEnfrcInfo || relocFlmEnfrcInfo">
                    <span v-if="flmEnfrcInfo">I also</span>
                    <span v-if="ppmFlmEnfrcInfo || relocFlmEnfrcInfo">And I</span>
                     understand each other party must be given notice of my application about enforcement.
                </p>


                <p v-if="flmPpmInfo || relocFlmInfo || flmEnfrcInfo || relocFlmPpmInfo || ppmFlmEnfrcInfo || relocFlmEnfrcInfo">
            ...
            <div class="m-3" v-if="ppmInfo || ppmEnfrcInfo">
                ...
                <p>
                    To give notice, they must each be served with a copy of the application and any supporting documents at 
