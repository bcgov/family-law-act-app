...
import Form50 from  "./pdf/Form50.vue"
...
export default class PreviewFormsNdt extends Vue {
    ...
    mounted(){
        ...
        if(this.checkErrorOnPages([this.stPgNo.OTHER._StepNo, this.stPgNo.NDT._StepNo])) this.dataReady = true;
        window.scrollTo(0, 0);
    }   
