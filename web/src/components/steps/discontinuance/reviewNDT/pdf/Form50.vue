<template>
    <div v-if="dataReady">
        <b-card id="print" style="border:1px solid; border-radius:5px;" bg-variant="white" class="mt-4 mb-4 container" no-body>
            <form-50-layout v-bind:result="result"/>
        </b-card>
    </div>
</template>
...
import Form50Layout from "./Form50Layout.vue"
...
export default class Form50 extends Vue {
    ...
    public onPrint() { 
        ...
        const bottomLeftText = `"PFA 767    `+moment().format("MM/YYYY")+` \\a           Form 50";`;
        const bottomRightText = `"Notice of Discontinuance | "`
        ...
        .then(res => {
            ...
            this.UpdatePathwayCompleted({pathway:"noticeDiscontinuance", isCompleted:true});
