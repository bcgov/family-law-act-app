...
<!-- <Header> -->
        <div>
             <div class="new-page" />
            <div style="text-align:center;"><b>SCHEDULE 12 –COMPANION ANIMAL AGREEMENT – EXISTING</b></div>
            <div style="text-align:center;"><b>This is Schedule 12 to the Application About a Family Law Matter</b></div>

            <div style="margin:1rem 0; text-align:justify">
                <i>
                    Complete this schedule only if you are making an application to set aside or replace all or 
                    part of an existing written agreement about a companion animal.
                </i>
            </div>
