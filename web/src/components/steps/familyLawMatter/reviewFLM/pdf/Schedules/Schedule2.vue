            ...
            <div style="display: flex; flex-direction: row;">
                <div style="width: 80%; padding-right: 4px;">
                    ...
                    <section>
                        ...
                        <div>
                            <check-box inline="inline" boxMargin="0" style="display:inline; margin:0 0 0 0.35rem;" :check="exParentArrInfo.type == 'ExistingOrder'" text="I have <b>a final court order</b> about parenting arrangements, including"/>
                            <br>
                            <GreyBoxForm v-if="exParentArrInfo.type == 'ExistingOrder'" style="margin-left:1.25rem; text-indent:0rem" textwidth="6rem" marginTop="-15px" beforetext="parental responsibilities or parenting time <b>  made on</b> <i>(date)</i>" aftertext="that I want to change or cancel (<i  style='color: #999'>see attached copy of order</i>). -->  <span style='color: #999'>Complete <b><i>Part 2</i></b></span>" hint="" :text="exParentArrInfo.existingDate | beautify-date-mid"/>
                            <GreyBoxForm v-else style="margin-left:1.25rem; text-indent:0rem" textwidth="6rem"  marginTop="-15px" beforetext="parental responsibilities or parenting time, <b>made on</b> <i>(date)</i>" aftertext="that I want to change or cancel (<i style='color: #999'>see attached copy of order</i>). -> <span style='color: #999'>Complete <b><i>Part 2</i></b></span>" hint="" text=""/>
                        </div>
                        <div>
                            <check-box inline="inline" boxMargin="0" style="display:inline; margin:0 0 0 0.35rem;" :check="exParentArrInfo.type == 'ExistingAgreement'" text="I have <b>a written agreement</b> about parenting arrangements, including"/>
                                <br>
                            <GreyBoxForm v-if="exParentArrInfo.type == 'ExistingAgreement'" style="margin-left:1rem; text-indent:0rem" textwidth="6rem"  marginTop="-15px" beforetext=" parental responsibilities or parenting time, <b>made on</b> <i>(date)</i>" aftertext="that I want to repeal or replace (<i style='color: #999'>see attached copy of order</i>).--> <span style='color: #999'>Complete <b><i>Part 3</i><b></span>" hint="" :text="exParentArrInfo.existingDate | beautify-date-mid"/>
                            <GreyBoxForm v-else style="margin-left:1rem; text-indent:0rem" textwidth="6rem"  marginTop="-15px" beforetext=" parental responsibilities or parenting time, <b>made on</b> <i>(date)</i>" aftertext="that I want to repeal or replace (<i style='color: #999'>see attached copy of order</i>). -> <span style='color: #999'>Complete <b><i>Part 3</i><b></span>" hint="" text=""/>
                        </div>
