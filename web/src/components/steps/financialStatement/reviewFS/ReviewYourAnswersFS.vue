...
import {whichForm} from './RequiredFormFsEFSP';
...
export default class ReviewYourAnswersFs extends Vue {
    ...
    {
        if(this.pageHasError) this.UpdatePathwayCompleted({pathway:"financialStatement", isCompleted:false})
    ...
    mounted(){
        ...
        this.form4 = requiredForm.includes('P4');
    ...
    public toggleFormPages(){
        ...
        togglePages([this.stPgNo.FS.PreviewFormsFS], !this.pageHasError && this.form4, this.currentStep);
        togglePages([this.stPgNo.FS.PreviewFormsFsEFSP], !this.pageHasError && this.form51, this.currentStep);        
    }

    public setFormsProgress(){
        Vue.filter('setSurveyProgress')(null, this.currentStep, this.stPgNo.FS.PreviewFormsFS,  50, false);
        Vue.filter('setSurveyProgress')(null, this.currentStep, this.stPgNo.FS.PreviewFormsFsEFSP,  50, false);      
    ...
    public checkStepHasError(){
        ...
        const optionalLabels = ["Preview Form 4","Preview Form 51"];        
    ...
    public reloadPageInformation() {
        ...
        this.questionResults = getQuestionResults([this.stPgNo.OTHER._StepNo, this.stPgNo.FS._StepNo], this.currentStep)
