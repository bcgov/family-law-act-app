...
export default class Form51 extends Vue {
    ...
    public onPrint() { 
        ...
        const pdf_type = Vue.filter('getPathwayPdfType')("electronicFilingStatementFs");
        const pdf_name = "electronic-filing-statement-fs";       
        ...
        .then(res => {
            ...
            this.UpdatePathwayCompleted({pathway:"electronicFilingStatementFs", isCompleted:true});
