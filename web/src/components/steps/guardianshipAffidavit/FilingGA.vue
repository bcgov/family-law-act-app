...
import surveyJson from "./forms/filling-ga.json";
...
export default class FilingGa extends Vue {
    ...
    public reloadPageInformation() {
        ...
        if (this.step.result?.filingGaSurvey) {            
            this.survey.data = this.step.result.filingGaSurvey.data;
    ...
    public setEfsDocumentList(){
        ...
        const efsDocumentList: electronicFilingDocumentInfoType[] = this.steps[this.stPgNo.GETSTART._StepNo].result?.gaEfsDocuments?.length>0?this.steps[this.stPgNo.GETSTART._StepNo].result.gaEfsDocuments:[];
