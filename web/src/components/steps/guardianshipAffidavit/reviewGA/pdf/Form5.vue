...
export default class Form5 extends Vue {
    ...
    mounted(){
        ...
        this.result = this.getGAResultData();       
        this.dataReady = true;
    ...
    public onPrint() { 
        ...
        const pdf_type = Vue.filter('getPathwayPdfType')("guardianshipAffidavit")
        const pdf_name = "guardianshipAffidavit";       
        ...
        .then(res => {
            ...
            this.UpdatePathwayCompleted({pathway:"guardianshipAffidavit", isCompleted:true});
