...
export default class ReviewYourAnswersNpr extends Vue {
    ...
    {
        togglePages([this.stPgNo.NPR.PreviewFormsNPR], !this.pageHasError, this.currentStep);
        if(this.pageHasError) this.UpdatePathwayCompleted({pathway:"noticeIntentionProceed", isCompleted:false})
        Vue.filter('setSurveyProgress')(null, this.currentStep, this.stPgNo.NPR.PreviewFormsNPR,  50, false);
    ...
    public reloadPageInformation() {
        ...
        this.questionResults = getQuestionResults([this.stPgNo.OTHER._StepNo, this.stPgNo.NPR._StepNo], this.currentStep)
