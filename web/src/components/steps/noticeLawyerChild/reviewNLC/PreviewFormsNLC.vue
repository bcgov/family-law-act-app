...
import Form40 from  "./pdf/Form40.vue"
...
export default class PreviewFormsNlc extends Vue {
    ...
    mounted(){
        ...
        if(this.checkErrorOnPages([this.stPgNo.OTHER._StepNo, this.stPgNo.NLC._StepNo])) this.dataReady = true;
        window.scrollTo(0, 0);
    }   
