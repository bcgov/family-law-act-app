...
export default class ReviewYourAnswersNlc extends Vue {
    ...
    {
        togglePages([this.stPgNo.NLC.PreviewFormsNLC], !this.pageHasError, this.currentStep);
        if(this.pageHasError) this.UpdatePathwayCompleted({pathway:"noticeLawyerChild", isCompleted:false})
        Vue.filter('setSurveyProgress')(null, this.currentStep, this.stPgNo.NLC.PreviewFormsNLC,  50, false);
    ...
    public reloadPageInformation() {
        ...
        this.questionResults = getQuestionResults([this.stPgNo.OTHER._StepNo, this.stPgNo.NLC._StepNo], this.currentStep)
