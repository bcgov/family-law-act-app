...
export default class ReviewYourAnswersNlp extends Vue {
    ...
    {
        togglePages([this.stPgNo.NLP.PreviewFormsNLP], !this.pageHasError, this.currentStep);
        if(this.pageHasError) this.UpdatePathwayCompleted({pathway:"noticeLawyerParty", isCompleted:false})
        Vue.filter('setSurveyProgress')(null, this.currentStep, this.stPgNo.NLP.PreviewFormsNLP,  50, false);
    ...
    public reloadPageInformation() {
        ...
        this.questionResults = getQuestionResults([this.stPgNo.OTHER._StepNo, this.stPgNo.NLP._StepNo], this.currentStep)
