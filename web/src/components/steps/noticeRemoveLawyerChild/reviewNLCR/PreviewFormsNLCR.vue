...
export default class PreviewFormsNlcr extends Vue {
    ...
    mounted(){
        ...
        if(this.checkErrorOnPages([this.stPgNo.OTHER._StepNo, this.stPgNo.NLCR._StepNo])) this.dataReady = true;
        window.scrollTo(0, 0);
    }   
