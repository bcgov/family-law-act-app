...
import Form43 from  "./pdf/Form43.vue"
...
export default class PreviewFormsNlpr extends Vue {
    ...
    mounted(){
        ...
        if(this.checkErrorOnPages([this.stPgNo.OTHER._StepNo, this.stPgNo.NLPR._StepNo])) this.dataReady = true;
        window.scrollTo(0, 0);
    }   
