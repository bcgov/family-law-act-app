...
export default class ReviewYourAnswersNlpr extends Vue {
    ...
    {
        togglePages([this.stPgNo.NLPR.PreviewFormsNLPR], !this.pageHasError, this.currentStep);
        if(this.pageHasError) this.UpdatePathwayCompleted({pathway:"noticeRemoveLawyerParty", isCompleted:false})
        Vue.filter('setSurveyProgress')(null, this.currentStep, this.stPgNo.NLPR.PreviewFormsNLPR,  50, false);
    ...
    public reloadPageInformation() {
        ...
        this.questionResults = getQuestionResults([this.stPgNo.OTHER._StepNo, this.stPgNo.NLPR._StepNo], this.currentStep)
