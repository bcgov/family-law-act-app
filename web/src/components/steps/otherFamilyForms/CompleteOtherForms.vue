        ...
        <b-card no-body class="bg-white border-white my-5">        
            ...
            <ul>
                <div v-for="otherForm, inx in selectedFormInfoList" :key="inx">
                    <li>
                        <b-row  class="my-2">
                            <b-col cols="6">{{otherForm.formName}} ({{ otherForm.formNumber }})</b-col>
                            <b-col cols="4">                                
                                <b-button  
...
export default class CompleteOtherForms extends Vue {
    ...
    otherFormsList: otherFormPathwayInfoType[] = [
        ...
        {formName: 'Fax Filing Cover Page',                                 formNumber: 'Form 52',  pathwayExists: false,    pathwayState: false, manualState: false,   pathwayName:'faxFilingCoverPage',           formLink:'https://www2.gov.bc.ca/assets/download/37FB0BCC59AE42EDA53C4C8569E47718?forcedownload=true'},
        {formName: 'Financial Statement',                                   formNumber: 'Form 52',  pathwayExists: false,    pathwayState: false, manualState: false,   pathwayName:'financialStatement',           formLink:'https://www2.gov.bc.ca/assets/gov/law-crime-and-justice/courthouse-services/court-files-records/court-forms/family/pfa713.pdf?forcedownload=true'},
