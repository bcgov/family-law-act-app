...
<!-- <1> -->
        ...
        <section style="width: 80%; line-height: 28px;">
            <grey-box-form marginTop="-22px" style="text-indent:2px;display:inline-block;" textwidth="16rem" beforetext="<b>My full name</b> is (full name of party):" :italicHint="false" :text="yourInfo.name | getFullName" hint=""/>
            <div style="margin-top: 0.1rem;"></div>
            <grey-box-form marginTop="-22px" style="display:inline;text-indent:2px;" textwidth="7rem" beforetext="My <b>date of birth</b> is (dd/mmm/yyyy):" :italicHint="false" :text="yourInfo.dob | beautify-date" hint=""/>
        </section>
        ...
        <section style="width: 80%; line-height: 28px;">
            <div v-for="(otherParty,inx) in otherPartyInfo" :key="inx" :style="inx==0?'display:inline;':'text-indent:-5px;margin-top:1rem;'">
                ...
                <div style="margin-top: 0.1rem;"></div>
                <grey-box-form marginTop="-22px" style="text-indent:2px;display:inline-block;" textwidth="16rem" beforetext="The <b>other party's full name</b> is:" :italicHint="false" :text="otherParty.name | getFullName" hint=""/>
                <div style="margin-top: 0.1rem;"></div>
