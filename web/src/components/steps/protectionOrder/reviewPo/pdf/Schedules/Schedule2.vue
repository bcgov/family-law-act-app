...
<!-- <Header> -->
    <div v-if="dataReady">
        ...
        <div style="background: #626262; color: white; font-size: 17pt; width: 80%;">
            <b><span style="font-size: 34pt;">Schedule 2</span> | Change an Existing Protection Order</b>
        </div>
...
<!-- <1> -->
        <section class="resetquestion">
            ...
            <grey-box-form marginTop="-22px" style="text-indent:0px;display:inline-block;" textwidth="8rem" beforetext="There is a <b>protection order made on</b>" hint="(dd/mmm/yyyy)" :text="aboutOrder.dateOfPO | beautify-date"/>
...
<!-- <2> -->
        ...
        <div style="float: right;width: 18%; margin-top: -130px;background: #d6d6d6;color: #747474;padding: 4px;line-height: 11px;">
            <p>
                <b-icon-info-circle-fill />
                <div style="font-size: 9px">The court can shorten or extend the expiration date of a protection order or change
                any term in it.</div>
            </p>
        </div>
...
<!-- <3> -->
        <section>  
            <i style="margin-left:.25rem;">Select only one of the options below and complete the requested information</i>
...
<!-- <4> -->
        <section>  
            ...
            <div class="answerbox" style="width: 98%;"> {{aboutOrder.whatChangesNeeded ? aboutOrder.whatChangesNeeded : '&nbsp;'}}</div>
        </section>
...
<!-- <5> -->
        <section>  
            ...
            <div class="answerbox" style="width: 98%;"> {{aboutOrder.whyChangesNeeded ? aboutOrder.whyChangesNeeded : '&nbsp;'}}</div>
        </section>
