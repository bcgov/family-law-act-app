    ...
    <div v-if="dataReady">
        ...
        <div style="display: flex; flex-direction: row;">
            <div style="width: 80%; padding-right: 4px;">
                <ScheduleHeader scheduleNumber="Schedule 3" scheduleTitle="Terminate Existing Protection Order" scheduleDescription=""></ScheduleHeader>
            </div>
        ...
        <div class="fla-col-left-80 fla-light-grey" style="border-style: none; border-color: black; width: 80%">
            Complete this schedule only if you have an existing protection order that you are applying to
            terminate.<br />
        ...
        <section class="resetquestion" style="width: 80%">
            <check-box inline="inline" boxMargin="0" checkbox="" style="display:inline; margin-left:0.5rem;"
                :check="true ? 'yes' : ''" text="" />
            <grey-box-form marginTop="-22px" style="text-indent:0px;display:inline-block;" textwidth="6.5rem"
                beforetext="There is a <b>protection order made on</b>" hintindent="2rem" hint="(dd/mmm/yyyy)"
                :text="aboutOrder.dateOfPO | beautify-date" />
            <div style="display:inline; margin-left:0.5rem;">that I am applying to terminate <b>(see attached copy of
                    order)</b>.</div>
        </section>
        ...
        <div
            style="float: right;width: 18%; margin-top: -330px;background: #d6d6d6;color: #747474;padding: 4px;line-height: 11px;">
            <p>
                <b-icon-paperclip />
        ...
        <section style="width: 80%">
            ...
            <i style="display:block; margin:0.25rem 0 0 1rem;">Explain why the order should be terminated and the facts
                you want the court to consider</i>
            <div class="answerbox" style="width:98%"> {{ aboutOrder.whyTerminatePO ? aboutOrder.whyTerminatePO :
                '&nbsp;'}}</div>
        </section>
