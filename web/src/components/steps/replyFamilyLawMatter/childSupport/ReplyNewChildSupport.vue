...
export default class ReplyNewChildSupport extends Vue {
    ...
    public reloadPageInformation() {
        ...
        if (this.step.result?.replyNewChildSupportSurvey) {
    ...
    public setPages(){
        ...
        if (this.survey.data?.agreeCourtOrder){
            ...
            togglePages([p.RelationshipToChild, p.DisagreeChildSupport, p.RflmCalculatingChildSupport, p.RflmAdditionalDocuments], this.survey.data.agreeCourtOrder == 'n', this.currentStep);
