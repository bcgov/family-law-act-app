...
export default class GuardianOfChild extends Vue {
    ...
    public setPages(){ 
        if (this.survey.data?.applicationType?.includes("cancelGuardian")) {                
            togglePages([this.stPgNo.RFLM.GuardianOfChildBestInterestsOfChild], true, this.currentStep);                
        } else {
            togglePages([this.stPgNo.RFLM.GuardianOfChildBestInterestsOfChild], false, this.currentStep);
        }
