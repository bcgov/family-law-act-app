...
import surveyJson from "./forms/calculating-spousal-support.json";
...
export default class CalculatingSpousalSupport extends Vue {
    ...
    public reloadPageInformation() {
        ...
        if (this.step.result?.calculatingSpousalSupportSurvey) {
