...
<!-- <Header> -->
        <div>
            ...
            <div style="display: flex; flex-direction: row; flex-wrap: no-wrap; gap: 4px;">
                <div style="flex: 1">
                    <ScheduleHeader scheduleNumber="Schedule 9" scheduleTitle="Child Support" scheduleDescription="No existing final order or written agreement"></ScheduleHeader>
                </div>
            ...
            <div style="margin-bottom: 1rem;"></div>
             ...
             <div style="display: flex; flex-direction: row; flex-wrap: no-wrap;">
                <div style="flex: 1">
                    ...
                    <span>Complete this schedule only if you need a court order about child support and you do not have an existing final court order or written agreement about child support.</span>
                    </NoteBox>
                </div>
                <div style="width: 20%;"></div>
            </div>
                ...
                <div style="width: 80%; padding-right: 4px;">
                    ...
                    <div> 
                        ...
                        <div style="margin-left:1rem;">
                            ...
                            <check-box boxMargin="0" shiftmark="0" :check="chSupInfo.opType.standing?'yes':''" text="a person standing in the place of a parent to the child(ren) <br> <i style='color:#999'>(for example, a step-parent)</i>"/>
                            <check-box boxMargin="0" shiftmark="0"  inline="inline" :check="chSupInfo.opType.other?'yes':''" text="other <i style='color:#999'>(specify):</i> "/>
                            <!-- <GreyBoxForm style="display:inline;text-indent:2px;" marginTop="-15px" textwidth="4rem" beforetext="" aftertext="." hint="" hintindent="10rem" :italicHint="false" :text="chSupInfo.opType.otherCom"/> -->
                            <div class="answerbox" style="min-height: 16px; padding: 8px; background: #dedede;"> {{chSupInfo.opType.otherCom}} </div>            
                        </div>
                    </div>
                </div>
                <div style="width: 20%;">
                    <NoteBox>
                        ...
                        <span>                
                            A child has the right to be supported by both parents, whether the parents ever lived together, or the parent has ever lived with the child. Other guardians and step parents may also be responsible for paying child support <i></i> 
                        </span>
                    </NoteBox>
                </div> 
            </div>
...
<!-- Part <2> -->
    ...
    <div style="display: flex; flex-direction: row;">
                ...
                <!-- <3> -->
                    ...
                    <div>
                        <b>4. </b> <i style="display:inline; margin-left:0.35rem color:#999">Select only one of the options below</i>
                        ...
                        <b-table
                            ...
                            >                    
                                ...
                                <template v-slot:head(reasonForSupport)>
                                    Reason for child support <br> <i style="font-size:6pt; font-weight:normal; color:#999">Select the applicable option</i>                            
                                </template>
                ...
                <div style="width: 20%;">
                    <NoteBox>
                        <b-icon-info-circle-fill /> <br>
                        <span>
                           A child, for the purposes of child support, includes a person who is over 19 years of age, and is unable because of illness, disability or another reason to obtain the necessities of life or withdraw from the charge of their parents <i>[s. 146 Family Law Act]</i>
                        </span>
                    </NoteBox>
                </div>    
            </div>
    ...
    <div class="print-block">      
        ...
        <div style="display: flex; flex-direction: row;">
            <div style="width: 80%; padding-right: 4px;">    
                <p style="margin-bottom: 10px;"><b>5.</b><i style="color:#999"> Select each applicable option and complete the requested information</i></p>
                <check-box inline="inline" textDisplay="inline" boxMargin="0" shiftmark="0" style="display: inline;" :check="chSupInfo.desiredSup.payor?'yes':''" text="I am applying for an order for ongoing support to be paid by "/>
                    <GreyBoxForm style="display:inline;text-indent:2px;" textwidth="12.5rem" marginTop="-15px" beforetext="<i style='color:#999'>(name of paying party)</i>" aftertext="in the monthly amount set out " hint="" hintindent="10rem" :italicHint="false" :text="chSupInfo.desiredSup.payor"/>
                <!-- <div class="answerbox" style="display:inline; padding: 2px 16px; background: #dedede;">{{chSupInfo.desiredSup.payor}}</div> -->
                <div style="display:inline;text-indent:0px;">in the child support guidelines for  
                    <GreyBoxForm style="display:inline;text-indent:2px;" marginTop="-12px" textwidth="4rem" beforetext="<i style='color:#999'>(number)</i>" aftertext="child(ren)." hint="" hintindent="10rem" :italicHint="false" :text="result.calculatingChildSupportSurvey.amountOfChildSupportPerMonth"/>
                </div>
                <div style="margin-left:2rem;">
                        ...
                        <GreyBoxForm style="display:inline;text-indent:2px;" marginTop="-15px" textwidth="4rem" beforetext="" aftertext="." hint="" hintindent="10rem" :italicHint="false" :text="result.calculatingChildSupportSurvey.amountOfChildSupportPerMonth"/>
                        <br>
            ...
            <div style="width: 80%; padding-right: 4px;">    
                <div>    
                    ...
                    <div style="padding-left:28px">
                        <p><i style="color:#999">List the expenses you are claiming for each child.</i><br>
                        <i style="color:#999">You must file a Financial Statement Form 4 to itemize the specific amounts.</i></p>
                        <div class="answerbox" style="min-height: 50px; background: #dedede;"></div>
                    </div>
                </div>
            </div>
            <div style="width: 20%;">
        ...
        <div style="display: flex; flex-direction: row;">
            <div style="width: 80%; padding-right: 4px;">  
                <div>
                    <div>
                        <div >
                            <check-box style="margin:0 0 0 1rem;"  boxShift="0" shiftmark="0" :check="chSupInfo.ndHard.change?'yes':''" text="I am applying for an order to <b>change the guideline amount payable</b> because the guideline amount would cause me <b>undue hardship</b> because i have:"/>                    
                        </div>
                        <div style="margin:0 0 3rem 3.25rem;">
                            ...
                            <div class="answerbox" style="min-height: 60px; padding: 8px; background: #dedede;">
            ...
            <div style="width: 80%; padding-right: 4px;">  
                <div class="print-block">        
                    ...
                    <div v-if="chSupInfo.desiredSup.reason" 
                        class="answerbox" style="padding: 8px; min-height: 60px; background: #dedede;">{{chSupInfo.desiredSup.reason}}</div>
            ...
            <div style="width: 80%; padding-right: 4px;">
                ...
                <div>
                    ...
                    <div style="padding-left: 15px;">        
                        <check-box boxMargin="0" shiftmark="0" :check="false"  text="<b>Yes</b> ➜ <i style='color:#999'>You <b>are required</b> to file a Financial Statement Form 4. Complete <b>Question 8</b>.</i>"/>
                        <check-box boxMargin="0" shiftmark="0" :check="false" text="<b>No</b> ➜ <i style='color:#999'>You <b>are not required</b> to file a Financial Statement Form 4 at this time. Skip to <b>Question 9</b>.</i>"/>        
                    </div>
                </div>
                <div style="background: #eee; border: 2px dashed #333; padding: 8px;">
                    <span><b>IMPORTANT NOTE:</b></span><br>
                    <span>You may also provide this financial information before receiving the other party’s reply to avoid delay, if you believe that the income of the other party is over $150,000 per year or that they will claim undue hardship, special or extraordinary expenses,or child support from you.</span>
                </div>
            </div>
            <div style="width: 20%;">
                <NoteBox>
        ...
        <div style="display: flex; flex-direction: row;">
            <div style="width: 80%; padding-right: 4px;">
                <div style="padding-top: 8px;">  
                    <span><b>8. I am required to file </b>a Financial Statement Form 4 to provide my income information to the court.</span> <br>  
                    <i style="color:#999">Select only one of the options below</i> 
                    <check-box boxMargin="0" shiftmark="0"  :check="chSupInfo.applyForCaseManagement?'yes':''" text="<b>I am filing</b> a Financial Statement in Form 4 with this application."/>
                    <check-box boxMargin="0" shiftmark="0"  :check="!chSupInfo.applyForCaseManagement && !chSupInfo.finStmnt.required?'yes':''" text="I am <b>not able to file</b> a Financial Statement in Form 4 with this application."/>
                    <div style="padding-left:28px">
    ...
    <div style="margin-top: 10px;"></div>
        <div style="display: flex; flex-direction: row;">
            <div style="width: 80%; padding-right: 4px;">
                ...
                <div class="print-block" style="background: #eee; border: 2px dashed #333; padding: 8px;">
                    <p><b>IMPORTANT NOTE TO THE OTHER PARTY:</b></p>
                    <span><b>This family law case includes an application about child support. You must provide your financial information with your reply to this application by completing and filing a Financial Statement in Form 4.</b></span>
...
export default class Schedule13 extends Vue {
    ...
    childrenSupportFields = [
        {key:"name",             label:"Full name of child",       tdClass:"text-center align-middle", thClass:"text-center align-middle", thStyle:"font-size:8pt; width:55%; border: none; border-bottom: 2px solid #333;"},
        {key:"reasonForSupport", label:"Reason for child support", tdClass:"text-center align-middle ", thClass:"text-center align-middle", thStyle:"font-size:8pt; width:35%; border: none; border-bottom: 2px solid #333;"},
    ]
