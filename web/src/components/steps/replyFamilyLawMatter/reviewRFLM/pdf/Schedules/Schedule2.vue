                ...
                <section>
                    ...
                    <div>
                        <div style="margin:0 0 0 3rem;">
                            <check-box 
                                :check="exParentArrInfo.cancel?'yes':''" 
...
import { schedule2DataInfoType } from '@/types/Application/ReplyFamilyLawMatter/Pdf';
...
export default class Schedule2 extends Vue {
    ...
    public getExistingParentingArrangementsInfo(){
        ...
        if(this.result.aboutParentingArrangementsSurvey?.existingType == 'ExistingOrder' ){
            ...
            existingParentingArrangements.cancel = false;
            existingParentingArrangements.change = true;
