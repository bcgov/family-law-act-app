...
<!-- <Header> -->
        <div>
            ...
            <div style="text-align:center;"><b>
                SCHEDULE 21 – COUNTER APPLICATION ABOUT PROPERTY DIVISION IN RESPECT OF A COMPANION ANIMAL – NEW
            </b></div>
            <div style="text-align:center;"><b>
                This is Schedule 21 to the Reply to an Application About a Family Law Matter with Counter Application
            </b></div>

            <div style="margin:1rem 0; text-align:justify">
                <i>
                    Complete this schedule only if you are or were a spouse of the other 
                    party and you are making a new counter application for a property division 
                    order about a companion animal.
                </i>
            </div>
...
<!-- <1> -->
            <section class="resetquestion"> 
                <div style="display:inline; margin-left:0.25rem">
                    I am applying for a property division order for <b>sole</b> ownership and 
...
export default class Schedule21 extends Vue {
