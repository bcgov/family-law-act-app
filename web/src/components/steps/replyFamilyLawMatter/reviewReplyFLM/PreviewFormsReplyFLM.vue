...
import Form6 from  "./pdf/Form6.vue"
...
export default class PreviewFormsReplyFlm extends Vue {
    ...
    mounted(){
        ...
        if(this.checkErrorOnPages([this.stPgNo.COMMON._StepNo, this.stPgNo.RFLM._StepNo])) this.dataReady = true;
        window.scrollTo(0, 0);
    }   
