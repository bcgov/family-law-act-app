...
export default class InterimOrder extends Vue {
    ...
    public determineQuestions(){
        ...
        if (this.step.result.reasonForSchedulingSurvey?.data){
            reasons = this.step.result.reasonForSchedulingSurvey.data;  
        }

        this.survey.setValue('orderChanged',reasons.includes('orderChanged'));
        this.survey.setValue('family',reasons.includes('family'));
