...
import surveyJson from "./forms/next-appearance.json";
...
export default class NextAppearance extends Vue {
    ...
    public reloadPageInformation() {
        ...
        if (this.step.result?.nextAppearanceSurvey) {
            this.survey.data = this.step.result.nextAppearanceSurvey.data;
    ...
    beforeDestroy() {      
        ...
        this.UpdateStepResultData({step:this.step, data: {nextAppearanceSurvey: Vue.filter('getSurveyResults')(this.survey, this.currentStep, this.currentPage)}})
    }
}
</script>
