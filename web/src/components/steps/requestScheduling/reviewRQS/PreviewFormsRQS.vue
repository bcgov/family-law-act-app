...
import Form39 from  "./pdf/Form39.vue"
...
export default class PreviewFormsRqs extends Vue {
    ...
    mounted(){
        ...
        if(this.checkErrorOnPages([this.stPgNo.OTHER._StepNo, this.stPgNo.RQS._StepNo])) this.dataReady = true;
        window.scrollTo(0, 0);
    }   
