<template>
    <div v-if="dataReady">
        <b-card id="print" style="border:1px solid; border-radius:5px;" bg-variant="white" class="mt-4 mb-4 container" no-body>
            <form-39-layout v-bind:result="result"/>
        </b-card>
    </div>
</template>
...
import Form39Layout from "./Form39Layout.vue"
...
export default class Form39 extends Vue {
    ...
    public onPrint() { 
        ...
        const bottomLeftText = `"PFA 732    `+moment().format("MM/YYYY")+` \\a           Form 39";`;
        const bottomRightText = `"Request for Scheduling | "`
