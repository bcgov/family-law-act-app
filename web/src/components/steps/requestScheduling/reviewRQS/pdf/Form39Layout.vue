...
<!-- Page 1 -->
        <FormHeader 
            ...
            formName="Request for Scheduling" 
            formNumber="FORM 39" 
            formRuleNumber="Rule 156"
            ruleFontSize="11pt">
        </FormHeader>
...
<!-- <3/4> -->
        <div style="display: flex; flex-direction: row;">
            ...
            <div style="width: 20%;margin-top:4px;">
                <NoteBox>
                    <b-icon-book />
                    <br />
                    <p>
            ...
            <div style="width: 80%; padding-right: 4px;">
                ...
                <div style="border:1px solid black; padding: 5px;">
                    ...
                    <underline-form 
                        ...
                        :italicHint="false" text=""/>
                    <div style="display: flex; flex-direction: row;">
                        <div style="width: 25%; margin-top: 16px;">
                            <check-box 
                                inline="inline" 
                                boxMargin="0" 
                                style="margin:0 0 0 0.5rem; display:inline;" 
                        ...
                        <div style="width: 74%; margin-top: 16px; border:1px solid black; padding: 5px;">
