        ...
        <div>
            <div style="margin:0rem 0 0rem 0; display:inline;">
                <check-box 
                    ...
                    check="'yes'" 
                    text="Step 1: Complete the Affidavit of Personal Service"/>               
            </div>   
            ...
            <p>
                The person who served the other party must complete the Affidavit of Personal Service 
                can complete the form online and print it for filing. The person can also complete it by hand. 
...
<!-- <Step 2> -->
    <div>
        ...
        <div style="margin:0 0 0.5rem 0;">
            The person who completed the service can go to any 
            <a 
                target="_blank" 
        ...
        <div>
            <div style="margin:0rem 0 0 0; display:inline;">
                <check-box 
                    ...
                    style="display:inline; margin:0 0.5rem 0 0; font-weight: 600;" 
                    check="" 
                    text="Step 3: File the Affidavit of Personal Service"/>               
            </div>  
...
export default class ApsChecklist extends Vue {
