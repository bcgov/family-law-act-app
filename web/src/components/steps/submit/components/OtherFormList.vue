...
export default class OtherFormList extends Vue {
    ...
    mounted(){
        ...
        this.formsListTemplate = [ 
            ...
            { name:'P42',  appName:'noticeLawyerParty',       pdfType: Vue.filter('getPathwayPdfType')("noticeLawyerParty"),       chkSteps:[this.stPgNo.OTHER._StepNo,this.stPgNo.NLP._StepNo],        color:"danger", title:"Notice of Lawyer for Party (Form 42)",            requiresSignature: false},
            { name:'P43',  appName:'noticeRemoveLawyerParty', pdfType: Vue.filter('getPathwayPdfType')("noticeRemoveLawyerParty"), chkSteps:[this.stPgNo.OTHER._StepNo,this.stPgNo.NLPR._StepNo],      color:"danger", title:"Notice of Removal of Lawyer for Party (Form 43)", requiresSignature: false},            
            { name:'P45',  appName:'affidavit',               pdfType: Vue.filter('getPathwayPdfType')("affidavit"),               chkSteps:[this.stPgNo.OTHER._StepNo,this.stPgNo.AFF._StepNo],        color:"danger", title:"Affidavit – General (Form 45)",                   requiresSignature: false},            
