...
import surveyJson from "./forms/witnesses.json";
...
export default class Witnesses extends Vue {
    ...
    public reloadPageInformation() {
        ...
        if (this.step.result?.witnessesSurvey) {            
            this.survey.data = this.step.result.witnessesSurvey.data;                      
            Vue.filter('scrollToLocation')(this.$store.state.Application.scrollToLocationName);            
        } else {
            this.survey.setValue('Witnesses',[]) 
        }
