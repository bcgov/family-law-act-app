...
export default class ReviewYourAnswersWR extends Vue {
    ...
    {
        togglePages([this.stPgNo.WR.PreviewFormsWR], !this.pageHasError, this.currentStep);
        if(this.pageHasError) this.UpdatePathwayCompleted({pathway:"writtenResponse", isCompleted:false})
        Vue.filter('setSurveyProgress')(null, this.currentStep, this.stPgNo.WR.PreviewFormsWR,  50, false);
    ...
    public reloadPageInformation() {
        ...
        this.questionResults = getQuestionResults([this.stPgNo.COMMON._StepNo, this.stPgNo.WR._StepNo], this.currentStep)
