...
export default class Form19 extends Vue {
    ...
    mounted(){
        ...
        this.result = this.getWRResultData(); 
    ...
    public getWRResultData() {         
        
        let result = Object.assign({},this.$store.state.Application.steps[0].result); 
        for(const stepIndex of [this.stPgNo.COMMON._StepNo, this.stPgNo.WR._StepNo]){
        ...
        // Vue.filter('extractRequiredDocuments')(result, 'writtenResponse')
