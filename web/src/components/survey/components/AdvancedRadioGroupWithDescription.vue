                        ...
                        :value="value">
                            <div :style="{margin:textBefore[index].length ==1? '0' :radioTextMargins}">
                                <div v-for="(n,inx) in (textBefore[index].length-1)" :key="inx" style="display:inline;"> 
                                    ...
                                    <div :class="textClass" style="display:inline;" v-html="textAfter[index][inx]" />
                                </div>
...
@Component
export default class AdvancedRadioGroupWithDescription extends Vue {
    ...
    mounted(){ 
        ...
        this.textAfter = this.splitData(this.question.textAfterInputs)
    ...
    public questionValidator(){
        this.question.validateValueCallback = () => {
            ...
            if(!this.pendingValue['selected']){
                ...
                if(this.textBefore[row].length<2 || this.textAfter[row].length<2) return null
            }            
            let error = null      
    ...
    public makeFields() {
        ...
        return fields;
            ...
            /* Example
            {
              ...
              "textAfterInputs":"{Enter exact date:},{};{I},{, the lawyer for},{, acknowledge it.}",
