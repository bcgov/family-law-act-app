<template>
    <div v-if="dataReady" class="survey-personname"> 
        ...
        <div  v-for="(choice,inx) in choices" :key="inx" style="padding-left: 0.5em;">
            ...
            <div v-if="checked[inx] && choice.comment" style="margin-left: 0.75rem;" v-html="choice.hint">{{choice.hint}}</div>
            <textarea 
...
export default class MultipleCommentWithDescriptionCheckbox extends Vue {
