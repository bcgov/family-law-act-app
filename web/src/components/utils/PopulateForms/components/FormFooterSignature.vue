        ...
        <div style="display: flex; font-size: 16px;">
            ...
            <div style="width: 55%; padding-right: 8px;">
                ...
                <div style="margin:.5rem 0 0 0">
                    <grey-box-form marginTop="-22px" style="margin-top:0.2rem; text-indent:3px;display:inline;" textwidth="20rem" hintTextColor="hintTextColor" beforetext="" hint="print name or affix stamp of commissioner" text="" />
                </div>
            </div>
            <!-- column 2 -->
            <div style="width: 16px; height: 250px; border: 1px solid #313131; border-left: 0;"></div>
            <!-- column 3 -->
            <div style="width: 40%; display: flex; flex-direction: column; margin-top: 122px;">
...
import GreyBoxForm from './GreyBoxForm.vue';
import UnderlineForm from './UnderlineForm.vue';
