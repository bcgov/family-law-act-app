export const FLA_Types = [
    ...
    {pathway:"replyCaseMgmt",               pdfType:"WRA",   appType:"WRA",   familyType:"WR",    fullName:"Reply to Application for Case Management Order"},
    {pathway:"replyProtectionOrder",        pdfType:"WRA",   appType:"WRA",   familyType:"WR",    fullName:"Reply to Application About a Protection Order"},
    {pathway:"replyPriorityParenting",      pdfType:"WRA",   appType:"WRA",   familyType:"WR",    fullName:"Reply to Application About a Priority Parenting Matter"},
    {pathway:"replyChildReloc",             pdfType:"WRA",   appType:"WRA",   familyType:"WR",    fullName:"Reply to Application for Order Prohibiting the Relocation of a Child"},
    {pathway:"replyAgreementEnfrc",         pdfType:"WRA",   appType:"WRA",   familyType:"WR",    fullName:"Reply to Application About Enforcement"},
    {pathway:"replyFamilyMaintenanceEnfrc", pdfType:"WRA",   appType:"WRA",   familyType:"WR",    fullName:"Reply to Application for Order Under the Family Maintenance Enforcement Act"},
