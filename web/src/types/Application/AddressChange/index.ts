...
export interface addessChangeOtherPartySurveyInfoType {
  data: any;
  questions: questionInfoType[];
  pageName: string;
  currentStep: number | string;
...
export interface addessChangeOtherPartySurveyDataInfoType {
  otherPartyNamesDynamicPanel: Array<otherPartyNameInfoType>;
}
